...
public class ActionFactory {
    ...
    static {
        ...
        map(INSTRUCTOR_FEEDBACK_RESPONSE_COMMENT_PRAISE_ADD, InstructorFeedbackResponseCommentPraiseAddAction.class);
        map(INSTRUCTOR_FEEDBACK_RESPONSE_COMMENT_PRAISE_DELETE, InstructorFeedbackResponseCommentPraiseDeleteAction.class);
        ...
        map(INSTRUCTOR_SEARCH_LIST_AJAX_PAGE, InstructorSearchListAjaxPageAction.class);
