...
public class FeedbackResponseComment extends BaseEntity {
    ...
    private List<String> praiseTo = new ArrayList<>();
    ...
    public FeedbackResponseComment(String courseId, String feedbackSessionName,
                                   ...
                                   List<FeedbackParticipantType> showGiverNameTo,List<String> praiseTo, String lastEditorEmail, Instant lastEditedAt) {
        ...
        this.praiseTo = praiseTo == null ? new ArrayList<String>() : praiseTo;
    ...
    public void setPraiseTo(List<String> praiseTo) {
        this.praiseTo = praiseTo;
    }

    public List<String> getPraiseTo() {
        return praiseTo;
    }
