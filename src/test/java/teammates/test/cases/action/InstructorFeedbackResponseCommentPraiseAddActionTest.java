...
/**
 * SUT: {@link InstructorFeedbackResponseCommentPraiseAddAction}.
 */
public class InstructorFeedbackResponseCommentPraiseAddActionTest extends BaseActionTest{


    @Override
    protected String getActionUri() {
        return Const.ActionURIs.INSTRUCTOR_FEEDBACK_RESPONSE_COMMENT_PRAISE_ADD;
    }
...
//        verifyAssumptionFailure(submissionParams);
        ...
        ______TS("Typical liked successful case for unpublished session");
        ...
        InstructorFeedbackResponseCommentPraiseAddAction action = getAction(submissionParams);
    ...
    @Override
    protected InstructorFeedbackResponseCommentPraiseAddAction getAction(String... params) {
        return (InstructorFeedbackResponseCommentPraiseAddAction) gaeSimulation.getActionObject(getActionUri(), params);
    }
